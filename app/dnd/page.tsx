  ...
  return (
    <div className="mt-20 grid place-items-center gap-5">
      <div className="flex gap-4">
        <Button onClick={() => handleAddWidget("button")}>新增連結按鈕</Button>
        <Button onClick={() => handleAddWidget("textarea")}>
          新增文字區域
        </Button>
      </div>
      ...
      <code className="whitespace-">{JSON.stringify(widgets, null, 2)}</code>
    </div>
  );
}
